...
public class AStarState
{
    ...
    public Waypoint getMinOpenWaypoint()
    {
        ...
        for (Waypoint waypoint : openWaypoints.values()){
            if (minCostWaypoint == null ||
                waypoint.getTotalCost() < minCostWaypoint.getTotalCost()){
                minCostWaypoint = waypoint;
            }
        }
    ...
    public boolean addOpenWaypoint(Waypoint newWP)
    {
        if (!openWaypoints.containsKey(newWP.loc) ||
            newWP.getTotalCost() < openWaypoints.get(newWP.loc).getTotalCost()){
